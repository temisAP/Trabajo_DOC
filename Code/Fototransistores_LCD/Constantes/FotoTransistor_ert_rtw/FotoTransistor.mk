###########################################################################
## Makefile generated for component 'FotoTransistor'. 
## 
## Makefile     : FotoTransistor.mk
## Generated on : Wed Jan 19 15:57:49 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/FotoTransistor.elf
...
PRODUCT_NAME              = FotoTransistor
MAKEFILE                  = FotoTransistor.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Siro/Desktop/Fototransistores_LCD/Constantes
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/Siro/DOCUME~1/MATLAB/R2021a/ARDUIN~1/ARDUIN~1/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/FotoTransistor.elf
...
DEFINES_STANDARD = -DMODEL=FotoTransistor -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = FotoTransistor.o FotoTransistor_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o updown.o ext_work.o rtiostream_utils.o LCD_Write_wrapper.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o
...
%.o : $(START_DIR)/FotoTransistor_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/FotoTransistor_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/FotoTransistor_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
FotoTransistor.o : $(START_DIR)/FotoTransistor_ert_rtw/FotoTransistor.c
	$(CC) $(CFLAGS) -o "$@" "$<"


FotoTransistor_data.o : $(START_DIR)/FotoTransistor_ert_rtw/FotoTransistor_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/FotoTransistor_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/FotoTransistor_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/FotoTransistor_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/FotoTransistor_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
LCD_Write_wrapper.o : $(START_DIR)/LCD_Write_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
