 ...
 * '<S5>'   : 'FotoTransistor/Subsystem/Horizontal Angle/Cálculo A'
 * '<S6>'   : 'FotoTransistor/Subsystem/Horizontal Angle/Cálculo B'
 * '<S7>'   : 'FotoTransistor/Subsystem/Horizontal Angle/Cálculo C'
 * '<S8>'   : 'FotoTransistor/Subsystem/Horizontal Angle/Cálculo alpha'
 * '<S9>'   : 'FotoTransistor/Subsystem/Vertical Angle/Cálculo A'
 * '<S10>'  : 'FotoTransistor/Subsystem/Vertical Angle/Cálculo B'
 * '<S11>'  : 'FotoTransistor/Subsystem/Vertical Angle/Cálculo C'
 * '<S12>'  : 'FotoTransistor/Subsystem/Vertical Angle/Cálculo alpha'
 */
